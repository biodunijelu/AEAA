using AEAA.Utilities.ExceptionUtility;
using System;
...
namespace AEAA.Utilities.AuthenticationUtility
{
    public class PasswordPolicyValidator
    {
        public static List<string> ValidatePasswordPolicy(string password, bool uppercase, bool requiredigit, bool lowercase, int requiredlength, bool reqnonalphanumeric)
        {
            ...
            if (password.ToLower().Contains("AEAA"))
            {
                result.Add(string.Format(ResponseErrorMessageUtility.CannotContainPassword, "AEAA"));
            }
            return result;
        }
    }
