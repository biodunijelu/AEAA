using AEAA.Utilities.AuthenticationUtility.UserAgent;
...
namespace AEAA.Utilities.AuthenticationUtility.AuthUser
{
    public class AuthUser : IAuthUser
    {
        ...
        public string AffiliateCode => _accessor.HttpContext.User?.FindFirst(PermissionConstants.AffiliateCode).Value;
