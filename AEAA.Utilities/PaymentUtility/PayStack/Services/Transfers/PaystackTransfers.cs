using AEAA.Payment.Core.Paystack.Interfaces;
using AEAA.Payment.Core.Paystack.Models.Transfers.Initiation;
using AEAA.Payment.Core.Paystack.Models.Transfers.Recipient;
using AEAA.Payment.Core.Paystack.Models.Transfers.TransferDetails;
using Newtonsoft.Json;
using System.Collections.Generic;
using System.Net.Http;
using System.Threading.Tasks;

namespace AEAA.Payment.Core.Services.Transfers
{
