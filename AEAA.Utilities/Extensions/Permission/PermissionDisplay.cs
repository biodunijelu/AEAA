...
namespace AEAA.Utilities.Extensions.Permission
{
    ...
    {
        public PermissionDisplay(string groupName, string name, string description, AEAAPermissions permission
            /*string moduleName*/)
        {
        ...
        /// </summary>
        public AEAAPermissions Permission { get; private set; }
        /// <summary>
        ...
        public static List<PermissionDisplay> GetPermissionsToDisplay(Type enumType)
        {
            ...
            foreach (var permissionName in Enum.GetNames(enumType))
            {
                ...
                var permission = (AEAAPermissions)Enum.Parse(enumType, permissionName, false);
